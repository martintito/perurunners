<div class ="col-xs-12 col-sm-12 col-md-9 col-lg-9 productos_con">
	<div class="row-fluid">
	   <ol class="breadcrumb">
		  ...
		  ?>
		  <li class="active"><?php echo $categoria_level;?></li>
			<?php }?>
	...
	<?php 
		...
		$nums=1;
		$count_query   = mysqli_query($con, "select count(*) AS numrows from productos, categorias where productos.id_categoria=categorias.id_categoria and $str_categoria  and productos.status_producto!=0");
		$rows= mysqli_fetch_array($count_query);
		$numrows = $rows['numrows'];
		$total_pages = ceil(($numrows) / $per_page);
		$sql_productos=mysqli_query($con,"select * from productos, categorias where productos.id_categoria=categorias.id_categoria and $str_categoria  and productos.status_producto!=0 order by productos.nombre_producto limit $offset,$per_page");
	...
	?>
		...
		<nav class="text-right">
		  <ul class="pagination">
			<li>
			  <a href="pagina/1/categoria/<?php echo $categoria;?>/<?php echo $lbl_producto;?>" aria-label="Previous">
			...
			<?php 
				 for ($i = 1; $i <= $total_pages; $i++) {
					 ...
					 ?>
					 <li class="<?php echo $active;?>"><a href="pagina/<?php echo $i;?>/categoria/<?php echo $categoria;?>/<?php echo $lbl_producto;?>"><?php echo $i;?></a></li>
					 <?php
				 }
			?>
		
			<li>
			  <a href="pagina/<?php echo $total_pages;?>/categoria/<?php echo $categoria;?>/<?php echo $lbl_producto;?>" aria-label="Next">
