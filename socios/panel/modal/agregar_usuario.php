  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-9">
		  <input type="email" class="form-control" id="user_email" name="user_email" placeholder="example@gmail.com" required>
		</div>
	  </div>
	  ...
	  <div class="form-group">
		<label for="user_status" class="col-sm-3 control-label">Estado</label>
		<div class="col-sm-9">
	  ...
	  <div class="form-group">
		<label for="ser_password_repeat" class="col-sm-3 control-label">Repite contraseña</label>
		<div class="col-sm-9">
