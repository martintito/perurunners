<?php
		...
		if (empty($_POST['business_name'])){
			...
			// escaping, additionally removing everything that could be (html/javascript-) code
				...
				// update data
                    $sql = "UPDATE business_profile SET name='".$business_name."', industry='".$industry."', number_id='".$number_id."', email='".$email."', phone='".$phone."', address='".$address."', tax='".$tax."', currency_id='".$currency."', timezone_id='".$timezone."' WHERE id='1' ";
