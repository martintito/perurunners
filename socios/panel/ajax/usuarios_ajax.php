<?php
	...
	if ($permisos_eliminar==1){//Si cuenta por los permisos bien
		...
		{
			$aviso="Aviso!";
			$msj="Error al eliminar los datos. No puede borrar el usuario administrador";
			$classM="alert alert-danger";
			$times="&times;";
		}
						...
						<tr>
							...
							<div class="btn-group pull-right btn-group-sm">
								...
								<ul class="dropdown-menu">
									...
									?>
									<li><a href="#" onclick="eliminar('<?php echo $user_id;?>')"><i class='fa fa-trash-o'></i> Borrar</a></li>
									<?php }?>
								</ul>
							</div><!-- /btn-group -->
                    		</td>
