    ...
    <div class="container">
      ...
      <div class="row">
	   ...
	   <ol class="breadcrumb">
		 ...
		 <div class="col-md-9">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Agregar página</h3>
			<form class="form-horizontal" id="editar_pagina">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-5">
				  ...
				  <input type="text" class="form-control" id="slug" value="<?php echo $slug;?>" required name="slug" readonly>
				</div>
			  </div>
			  <div class="form-group">
