...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
	   ...
	   <ol class="breadcrumb">
		 ...
		 <div class="col-md-6">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Agregar categoría</h3>
			<form class="form-horizontal" id="guardar_categorias">
	...
	<script>
		$("#guardar_categorias").submit(function(e) {
			
			  $.ajax({
				  url: "ajax/guardar_categorias.php",
				  type: "POST",
				  data: $("#guardar_categorias").serialize(),
