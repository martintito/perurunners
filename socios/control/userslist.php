			...
			<div class="row">
			  <div class="col-xs-4">
				<div class="input-group">
					<input type="text" class="form-control" placeholder="Buscar por usuario" id="q" onkeyup="load(1);">
			  ...
			  <div class="col-xs-8 text-right">
				  <a href='usersadd.php' class="btn btn-default" ><span class="glyphicon glyphicon-plus"></span> Agregar Usuarios</a>
			  </div>
