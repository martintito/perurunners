		  ...
		  <li class="active">Categorías</li>
			...
			<div class="row">
			  ...
			  <div class="col-xs-8 text-right">
				  <a href='categoryadd.php' class="btn btn-default" ><span class="glyphicon glyphicon-plus"></span> Agregar Categorías</a>
			  </div>
...
<script>
	...
	function eliminar_categoria(id){
		...
		if(confirm('Esta acción  eliminará de forma permanente la categoría \n\n Desea continuar?')){
		$.ajax({
			url:'./ajax/categorias_ajax.php',
			data: parametros,
			 beforeSend: function(objeto){
