...
$sql=mysqli_query($con,"select * from paginas where id_pagina=2 and estado=1");
$rw=mysqli_fetch_array($sql);
$titulo=$rw['titulo'];
$contenido=$rw['descripcion'];
$canonical_link="servicio";
$meta_description="$business_name ofrece servicio al cliente rápido y confiable.";
include ("header.php");
//include ("logo.php");
include("slider.php");
?>
